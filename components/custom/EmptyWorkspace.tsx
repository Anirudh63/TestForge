...
function EmptyWorkspace({ onAddRepo, hasToken, setRefreshPage, addedRepoIds = [] }: EmptyWorkspaceProps) {
    return (
        <div className='flex flex-col items-center justify-center py-20 px-6 text-center'>
            ...
            {hasToken && setRefreshPage ? (
                <RepoDialog setRefreshPage={setRefreshPage} addedRepoIds={addedRepoIds} />
            ) : (
